...
<?php
	...
	if (mysql_num_rows($query) == 0) {
		?>
			<div class="contentCont" style="width: 80%; text-align: center;">
			There's no post yet
			<form method="POST" name="CreatePostGram" action="sqls.php">
				<input type="hidden" name="idLesson" value="<?php echo $idLesson; ?>"></input>
		...
		echo '<input type="hidden" name="idLesson" value="'.$idLesson.'"></input>';
